...
public class MainController implements Controller<Node> {
  ...
  public void initialize() {
    ...
    transientNotificationsController.getRoot().getChildren().addListener(new PopupDisplayer(transientNotificationsController));
  ...
  public class PopupDisplayer implements InvalidationListener {
    ...
    public PopupDisplayer(TransientNotificationsController transientNotificationsController) {
